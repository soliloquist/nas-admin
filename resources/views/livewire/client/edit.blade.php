@if($finish)
    <div>
        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            <div>
                <img class="w-auto" src="{{ $client->getFirstMediaUrl() }}" alt="">
            </div>
            <div class="flex mt-2">
            ...
            <div class="flex">
                <div class="md:w-1/5 text-gray-700 font-medium">連結網址</div>
                <div>{{ $client->link }}</div>
            </div>
...
@else
    ...
    <form wire:submit.prevent="save">
        ...
        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            @if($client->getFirstMedia() && !$image)
                <div>
                    <img src="{{ $client->getFirstMediaUrl() }}" alt="" class="w-auto">
                </div>
            @endif
            ...
            <div>
                ...
                @error('client.name') <span class="text-red-600">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                @error('client.link') <span class="text-red-600">{{ $message }}</span> @enderror
            </div>
