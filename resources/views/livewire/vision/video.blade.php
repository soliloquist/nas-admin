@if($finish)
    <div>
        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            <div class="flex">
                <div class="md:w-1/5 text-gray-700 font-medium">下載連結</div>
            ...
            <div>
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                    <input
                        ...
                        placeholder="https://www.youtube.com/watch?v=QFoapxPvZy4">
                </div>
                <div class="text-sm text-gray-600 mt-2">
                    請使用 Youtube 標準連結，格式如： https://www.youtube.com/watch?v=cG93H3ccBuM
                </div>
