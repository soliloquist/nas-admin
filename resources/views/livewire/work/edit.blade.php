...
{{--                    </div>--}}
        ...
        <input type="hidden" wire:model="work.language_id"/>
        <input type="hidden" wire:model="work.group_id"/>
