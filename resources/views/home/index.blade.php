                ...
                <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="text-sm font-medium text-gray-900">
                                    桌機版 Video Banner 影片網址
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            {{ $bannerVideo->value ?? '未設定' }}
                        </td>

                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('home.edit.banner-video') }}"
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="text-sm font-medium text-gray-900">
                                    桌機版 Video Banner 影片替代圖
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">

                            @if($bannerVideo->getFirstMediaUrl())
                                <img src="{{ $bannerVideo->getFirstMediaUrl() }}" alt="" class="max-h-32">
                            @else
                                未設定
                            @endif
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('home.edit.banner-video-cover') }}"
                               class="text-indigo-600 hover:text-indigo-900">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                     viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
