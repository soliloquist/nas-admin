...
Route::get('/getBusinessDetail/{id}', [\App\Http\Controllers\API\OurBusinessController::class, 'show']);
Route::get('/getＷork', [\App\Http\Controllers\API\OurWorkController::class, 'index']);
Route::get('/getＷorkDetail/{id}', [\App\Http\Controllers\API\OurWorkController::class, 'show']);
Route::get('/getUpdate', [\App\Http\Controllers\API\UpdateController::class, 'index']);
Route::get('/getUpdateDetail/{id}', [\App\Http\Controllers\API\UpdateController::class, 'show']);
